    ...
    <div class="container">
        <div class="row mt-5 d-flex justify-content-center">
            ...
            <?php foreach ($products as $product) : ?>
                <div class="card mt-3 mb-3 me-3" style="width: 18rem;">
            ...
            <nav aria-label="Page navigation example" class="d-flex justify-content-center">
                <ul class="pagination">
                    ...
                    <?php if ($currentPage > 1) : ?>
                        <li class="page-item"><a href="?page=<?= $currentPage - 1 ?>" class="page-link">Previous</a></li>
                    <?php endif; ?>
                    ...
                    <?php for ($i = max(1, $currentPage - 2); $i <= min($currentPage + 2, $totalPages); $i++) : ?>
                        <li class="page-item <?= $currentPage == $i ? 'active' : '' ?>"><a href="?page=<?= $i ?>" class="page-link"><?php echo $i ?></a></li>
                    <?php endfor; ?>
